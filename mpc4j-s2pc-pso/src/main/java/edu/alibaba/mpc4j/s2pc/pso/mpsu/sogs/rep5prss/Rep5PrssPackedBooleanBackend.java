...
public class Rep5PrssPackedBooleanBackend implements PackedBooleanBackend {
    ...
    public Rep5PrssPackedBooleanBackend(Rpc rpc, int batchSize, long taskId) {
        this(rpc, batchSize, taskId, new Rep5PrssSession(rpc, taskId), 0L, PrssPhase.FULL);
    }

    Rep5PrssPackedBooleanBackend(Rpc rpc, int batchSize, long taskId, Rep5PrssSession session,
    ...
    private Rep5PrssPackedBooleanShare buildShareForDealer(int dealerId, int stepId, long operationId,
