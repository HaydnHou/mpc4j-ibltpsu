...
/**
 * Plain payload-bound BA-UPOT two-party benchmark tests.
 *
 * @author donghai hou
 * @date 2026/06/03
 */
public class BaUpotPlainPayloadTwoPartyBenchmarkTest {
    /**
     * element byte length.
     */
    ...
    public void testManualOutputs() throws InterruptedException {
        ...
        BaUpotTwoPartyBenchmark.BenchmarkConfig config = new BaUpotTwoPartyBenchmark.BenchmarkConfig()
            ...
            .setCheckBits(182)
            .setTagBits(182)
            .setOnlineBatchSize(17);
        BaUpotPlainPayloadTwoPartyBenchmark.Result result =
            BaUpotPlainPayloadTwoPartyBenchmark.runMemoryBenchmarkWithOutputs(config, outputs);
        Assert.assertTrue(result.isChecksumEqual());
        assertOutputsEqual(outputs, result.getDecodedOutputs());
        BaUpotPlainOutputCapsuleCodec codec = BaUpotPlainOutputCapsuleCodec.fromConfig(config.createBaUpotConfig());
    ...
    public void testTraceOutputs() throws InterruptedException {
        ...
        Assert.assertTrue(plainResult.hasBucketTrace());
        BaUpotTwoPartyBenchmark.BenchmarkConfig config = new BaUpotTwoPartyBenchmark.BenchmarkConfig()
            ...
            .setOnlineBatchSize(37);
        BaUpotPlainPayloadTwoPartyBenchmark.Result payloadResult =
            BaUpotPlainPayloadTwoPartyBenchmark.runMemoryBenchmark(config, plainResult.getBucketTrace());
        Assert.assertTrue(payloadResult.isChecksumEqual());
        ...
        assertOutputsEqual(expectedOutputs, payloadResult.getDecodedOutputs());
    }
