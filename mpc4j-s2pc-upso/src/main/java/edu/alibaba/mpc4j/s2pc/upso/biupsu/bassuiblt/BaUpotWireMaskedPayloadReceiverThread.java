...
/**
 * Wire-masked payload-bound BA-UPOT receiver thread.
 *
 * @author donghai hou
 * @date 2026/06/03
 */
class BaUpotWireMaskedPayloadReceiverThread extends Thread {
    /**
     * receiver.
     */
    private final BaUpotWireMaskedPayloadReceiver receiver;
    /**
     * bucket indices.
     */
    ...
    public BaUpotWireMaskedPayloadReceiverThread(BaUpotWireMaskedPayloadReceiver receiver,
    ...
    public BaUpotWireMaskedPayloadReceiverThread(BaUpotWireMaskedPayloadReceiver receiver, int bucketNum,
