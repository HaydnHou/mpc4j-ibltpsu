...
/**
 * Wire-masked payload-bound BA-UPOT sender thread.
 *
 * @author donghai hou
 * @date 2026/06/03
 */
class BaUpotWireMaskedPayloadSenderThread extends Thread {
    /**
     * sender.
     */
    private final BaUpotWireMaskedPayloadSender sender;
    /**
     * outputs.
     */
    ...
    public BaUpotWireMaskedPayloadSenderThread(BaUpotWireMaskedPayloadSender sender,
                                               List<BaUpotBucketOutput> outputs) {
        this(sender, outputs == null ? -1 : outputs.size(), outputs == null ? null : List.copyOf(outputs));
    }

    public BaUpotWireMaskedPayloadSenderThread(BaUpotWireMaskedPayloadSender sender, int bucketNum,
