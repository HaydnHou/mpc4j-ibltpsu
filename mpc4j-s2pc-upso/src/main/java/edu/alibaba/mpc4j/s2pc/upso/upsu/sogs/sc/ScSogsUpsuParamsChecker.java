...
/**
 * SC-SOGS UPSU parameter checker.
 *
 * @author donghai hou
 * @date 2026/06/19
 */
public class ScSogsUpsuParamsChecker {

    private ScSogsUpsuParamsChecker() {
        // empty
    }

    public static boolean checkValid(ScSogsUpsuParams params) {
